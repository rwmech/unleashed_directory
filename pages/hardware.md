...
Four ways to build one. Each is a choice, not a step on a ladder:
...
- **Auto levels**, a new setting, on as shipped, which evens out a flat or
  washed-out photo on any camera.
